...
def perform_operation(file_name):
    ...
    name="F:\\Udemy\\IEEE Project Hackathon 2020\\project\\media\\edited_images\\" + name
    #print(name)
...
#Function Call
perform_operation("F:\\Udemy\\IEEE Project Hackathon 2020\\project\\media\\profile_pics\\img4.jpg")
